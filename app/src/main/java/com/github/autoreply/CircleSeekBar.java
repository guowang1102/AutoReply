...
public class CircleSeekBar extends View {
    ...
    private Paint mSeekBarCenterCirclePaint = null;
    private Paint mSeekBarCenterCirclePaint2 = null;
    ...
    private void initView() {
        ...
        mThumbWidth = this.mThumbDrawable.getIntrinsicWidth() * 3 / 2;
        mThumbHeight = this.mThumbDrawable.getIntrinsicHeight() * 3 / 2;
        ...
        mSeekBarCenterCirclePaint = new Paint();
        mSeekBarCenterCirclePaint2 = new Paint();

        mSeekbarProgressPaint.setColor(progressFrontColor);
        mSeekBarBackgroundPaint.setColor(progressBackgroundColor);
        mSeekBarCenterCirclePaint.setColor(progressFrontColor);
        mSeekBarCenterCirclePaint2.setColor(progressFrontColor);

        mSeekbarProgressPaint.setAntiAlias(true);
        mSeekBarBackgroundPaint.setAntiAlias(true);
        mSeekBarCenterCirclePaint.setAntiAlias(true);
        mSeekBarCenterCirclePaint2.setAntiAlias(true);

        mSeekbarProgressPaint.setStyle(Paint.Style.STROKE);
        mSeekBarBackgroundPaint.setStyle(Paint.Style.STROKE);
//        mSeekBarCenterCirclePaint.setStyle(Paint.Style.STROKE);
        mSeekBarCenterCirclePaint2.setStyle(Paint.Style.STROKE);

        mSeekbarProgressPaint.setStrokeWidth(progressWidth);
        mSeekBarBackgroundPaint.setStrokeWidth(progressWidth);
//        mSeekBarCenterCirclePaint.setStrokeWidth(progressWidth);
        mSeekBarCenterCirclePaint2.setStrokeWidth(5);
...
//        }
        ...
        if (true == mIsShowProgressText) {
            float textWidth = mProgressTextPaint.measureText("" + mCurrentProgress);
            canvas.drawText("" + mCurrentProgress, mSeekBarCenterX - textWidth / 2, mSeekBarCenterX*2
                    + 120, mProgressTextPaint);
        }
    }

    private void drawCenterCircle(Canvas canvas) {
        int radius = mSeekBarRadius / 5;
        canvas.drawCircle(mSeekBarCenterX, mSeekBarCenterY, radius,
                mSeekBarCenterCirclePaint);

        canvas.drawCircle(mSeekBarCenterX, mSeekBarCenterY, radius + 10,
                mSeekBarCenterCirclePaint2);
    }
